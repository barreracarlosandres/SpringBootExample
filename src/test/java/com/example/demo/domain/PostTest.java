...
class PostTest {
    ...
    void tryToCreateNewPostWithIdPostNoValid0() {
        ...
        //act - assert
        Exception exception = Assertions.assertThrows(RuntimeExceptionValue.class, () ->
...
//                .build();
        //act - assert
        Exception exception = Assertions.assertThrows(RuntimeExceptionNullValue.class, () ->
//                new Post(commandPost.getIdPost(), commandPost.getTitle(), commandPost.getBody()));
                new Post(100, null, "body"));
